...
public class LibraryTest {
    ...
    public void test_getManager() {
        assertEquals(testLib.getManager(), testLibrarian);
    }

    @Test
    public void test_inCatalogue() {
    ...
    @Test
    public void test_isInDiffBranch() {
        Book bk = new Book("Algorithms 101", "Pippuzzo Caluzzo", TEXTBOOK, 2001, 5);
        otherLib = new Library("Copenhagen Public Library", testLibrarian);
        testLib.addBranch(otherLib);
        otherLib.storeBook(bk);
        assertTrue(testLib.isInDiffBranch(bk));
    }

    @Test
    public void test_hireLibrarian() {
        Librarian otherLibrarian = new Librarian("Ken Parker", 18, testLib, ficBook);
        testLib.hireLibrarian(otherLibrarian);
        assertEquals(otherLibrarian, testLib.getManager());
    }

    @Test
    public void test_fireLibrarian() {
        testLib.hireLibrarian(null);
        assertEquals(null, testLib.getManager());
    }
