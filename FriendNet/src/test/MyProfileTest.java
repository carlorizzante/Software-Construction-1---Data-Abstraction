...
public class MyProfileTest {
    ...
    @Test
    public void test_canFindPerson() {
    ...
    @Test
    public void test_eventNumNearMe() {
    ...
    @Test
    public void test_upcomingEventNum() {
    ...
    @Test
    public void test_specificEventType() {
        Event ev5 = new Event("Amanda's Wedding", "June 19", "Copenhagen", WEDDING);
        mainProfile.addEvent(ev5);
        assertEquals(mainProfile.specificEventType(WEDDING), 2);
        assertEquals(mainProfile.specificEventType(PARTY), 1);
